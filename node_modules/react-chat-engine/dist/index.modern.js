...
import { CloseOutlined, SyncOutlined, MenuOutlined, LeftOutlined, DownOutlined, SettingOutlined, LoadingOutlined, FileOutlined, CloseCircleTwoTone, PaperClipOutlined, ArrowUpOutlined, PlusOutlined, DeleteOutlined, UserAddOutlined } from '@ant-design/icons';
...
var FileView = function FileView(props) {
  ...
  var style = _extends({}, styles$e.fileView, {
  ...
  if (!attachment) {
    return /*#__PURE__*/React.createElement("div", {
      style: styles$e.loadingContainer
    }, /*#__PURE__*/React.createElement(LoadingOutlined, {
      style: {
        color: 'white',
        padding: '4px',
...
var Dot = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: _extends({}, styles$f.dot, customStyle, {
...
var TheirMessage = function TheirMessage(props) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: _extends({}, styles$h.theirMessage, {
      borderRadius: borderRadius
    })
  }, /*#__PURE__*/React.createElement(Body, {
    text: message.text
...
var SendingMessage = function SendingMessage(props) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "ce-message-bubble ce-my-message-bubble",
    style: _extends({}, styles$i.myMessage, {
      borderRadius: borderRadius
    })
  }, /*#__PURE__*/React.createElement(Body, {
    text: message.text
...
var FilePreview = function FilePreview(props) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: _extends({}, styles$j.filePreview, {
...
var NewMessageForm$1 = function NewMessageForm() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: styles$m.NewMessageFormContainer,
...
var Avatar = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "ce-avatar",
      style: _extends({}, styles$o.avatar, customStyle, {
        backgroundColor: this.state.avatar ? 'white' : color,
        backgroundImage: this.state.avatar && "url(" + this.state.avatar + ")",
        backgroundRepeat: 'no-repeat',
        backgroundPosition: 'center',
...
var Button = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    var hoverStyle = this.state.hovered ? styles$p.hoverButton : {};
    var themeStyle = theme === 'danger' ? styles$p.dangerButton : styles$p.button;
...
var TextInput = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    var customStyle = this.props.style ? this.props.style : {};
    var defaultStyle = this.state.focused ? styles$q.focusInput : styles$q.input;
    return (
      /*#__PURE__*/
...
var AutoComplete = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    var defaultStyle = _extends({}, styles$r.input, {
